		...
		<button class="btn btn-primary" name="checkout" >Checkout</button>
			...
			if (isset($_POST["checkout"]))
			{
				...
				foreach ($_SESSION["keranjang"] as $id_produk => $jumlah)
				{
					...
					$kategori=$perproduk['kategori_produk'];

					$subharga=$perproduk['harga_produk']*$jumlah;
					$action = mysqli_query($koneksi,"INSERT INTO pembelian_produk (id_pembelian,id_produk,nama,harga,kategori,subharga,jumlah)
					VALUES ('$id_pembelian_barusan','$id_produk','$nama','$harga','$kategori','$subharga','$jumlah')");
					if($action){
